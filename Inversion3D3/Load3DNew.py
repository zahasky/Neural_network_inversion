...
class InputDataset(Dataset):
    ...
    def __init__(self, transform=None):
        ...
        for i in index_1:
            index_2 = [y for y in range(108,109)] #indeces for every .csv file
...
encoder.load_state_dict(torch.load('./encoder_epoch251.pth', map_location='cpu'))
encoder.eval()

decoder.load_state_dict(torch.load('./decoder_epoch251.pth', map_location='cpu'))
decoder.eval()
