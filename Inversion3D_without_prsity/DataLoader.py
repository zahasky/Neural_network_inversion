...
class InputDataset(Dataset):
    ...
    def __init__(self, transform=None):
        ...
        time_field_dir = os.path.join('.', 'ht3D')
        ...
        for i in index_1:
            ...
            for j in index_2:
                ...
                # Pre-processing the input (arrival time), labeling (permeability), and boundary condition (mean permeability) data
                ...
                # Taking the natural logrithm of all the data
                ...
                # Adding the boundary condition (mean permeability) to the input (arrival time) data
