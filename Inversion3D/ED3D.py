...
class Encoder(nn.Module):
    def __init__(self, inchannels=1, outchannels=1, filters=48, num_res_blocks=1):
        ...
        self.conv1 = nn.Conv3d(inchannels, filters, kernel_size=4, stride=2, padding=1)
        ...
        self.trans1 = nn.Sequential(
            ...
            nn.Conv3d(filters, outchannels, kernel_size=4, stride=2, padding=1),
        )
    ...
    def forward(self, img):
        ...
        out1 = self.conv1(img)          # filters x 10 x 10 x 20
        out2 = self.res_blocks(out1)    # filters x 10 x 10 x 20
        out3 = self.trans1(out2)        # outchannels x 5 x 5 x 10
        return out3
