...
np_por = por_tensor_coarse[0,:,:,:].cpu().detach().numpy()
save_filename = 'D:\\Dropbox\\Codes\\Deep_learning\\Neural_network_inversion\\experimental_data_prep\\pet_data'  + '\\' 'berea_dry_norm_coarse.csv'
save_data = np_por.flatten('C')
...
norm = matplotlib.colors.Normalize(vmin=0.22, vmax=0.25)
